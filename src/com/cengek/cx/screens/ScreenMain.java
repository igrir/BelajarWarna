...
import com.cengek.cx.manager.GameSettings;
...
public class ScreenMain extends Screen{
	...
	public ScreenMain(Graphics g, MIDlet m, LayerManager lg, GameManager host) {
	...
	public void putBtnPlay(){
		...
		btn_play.setTransform(Sprite.TRANS_MIRROR_ROT270);
	}
	...
	public void putBtnSettings(){
		...
		btn_settings.setTransform(Sprite.TRANS_ROT270);
	}
	...
	public void putBtnExit(){
		...
		btn_exit.setTransform(Sprite.TRANS_ROT270);
	}
